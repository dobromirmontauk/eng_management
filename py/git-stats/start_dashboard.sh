...
cd "$(dirname "$0")/.."  # Go to py directory
nohup python -m streamlit run git-stats/streamlit_app.py --server.headless true --server.port 8501 --server.address 0.0.0.0 > git-stats/streamlit.log 2>&1 &
STREAMLIT_PID=$!
